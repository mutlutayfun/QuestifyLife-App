...
// İkonları tekrar tanımlayalım (veya ayrı bir bileşene taşıyabilirsin)
const EyeIcon = () => (
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input 
                                ...
                                className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary pr-10"
                            ...
                            <button
                                ...
                                className="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500 hover:text-secondary transition-colors focus:outline-none"
                            >
